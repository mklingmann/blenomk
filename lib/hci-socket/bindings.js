...
// marco:start
BlenoBindings.prototype.updateAdvertisementData = function(advertisementData, scanData) {
  if (this._advertising === true) {
    this._gap.updateAdvertisementData(advertisementData, scanData);
  }
  else {
